...
%  \begin{center}
%  \begin{psfrags}
%  \psfrag{f-}{\small\color{red}$\!\!\!\!\!\!\!\!f(x_0)-\varepsilon$}
%  \psfrag{f+}{\small\color{red}$f(x_0)+\varepsilon$}
%  \psfrag{f}{\small$f(x_0)$}
%  \psfrag{x-}{\small\color{green}$\!\!\!\!x_0-\delta$}
%  \psfrag{x+}{\small\color{green}$\!\!\!\!x_0+\delta$}
%  \psfrag{x}{\small$\!\!\!\!x_0$}
%  \centering
%  \includegraphics[width=0.91\textwidth,angle=0]{pics/epsdelt.eps}
%  \end{psfrags}
%  \caption{$\varepsilon$-$\delta$ criterion graphically illustrated}\label{fig:epsdelt}
%  \end{center}
%  \end{figure}
