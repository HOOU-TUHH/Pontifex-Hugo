...
% \begin{center}
% \begin{psfrags}
% \psfrag{x}{\scriptsize $\hat{x}$}
% \psfrag{a}{\scriptsize $a$}
% \psfrag{b}{\scriptsize $b$}
% \psfrag{f}{\scriptsize $f$}
% \psfrag{tangent}{\scriptsize tangent}
% \psfrag{secant}{\scriptsize secant}
% \includegraphics[width=0.51\textwidth,angle=0]{pics/meanval.eps}
% \caption{Mean value theorem}\label{fig:meanval}
% \end{psfrags}
% \end{center}
% \end{figure}
