\section{Bounded, Open, Closed and Compact Sets}
\noindent Next, we define some particular sets and special properties of sets.
\begin{Definition}{$\varepsilon$-neighbourhood}
 Let $x\in \mathbb{K}$. Then for $\varepsilon>0$, the \defi{$\eps$-neighbourhood of $x$} is defined by the set
\[B_{\varepsilon}(x)=\{y\in \mathbb{K}\,:\,|x-y|<\varepsilon\}.\]
A~set $M\subset \mathbb{K}$ is called \defi{neighbourhood of $x$}, if there exists some $\varepsilon>0$ such that
...
\begin{enumerate}[(i)]
 \item \defi{bounded} if there exists some $c \in \mathbb{R}$ such that for all $x\in M$ holds: $|x|\leq c$. 
 \item \defi{open} if for all $x\in M$ holds: $M$ is a~neighbourhood of $x$.
 \item \defi{closed} if for all convergent sequences $(a_n)_{n\in\mathbb{N}}$ with $a_n\in M$ for all $n\in\mathbb{N}$ holds: $\lim_{n\To\infty}a_n=a\in M$.
 \item \defi{compact}  if for all sequences $(a_n)_{n\in\mathbb{N}}$ with $a_n\in M$ for all $n\in\mathbb{N}$ holds: There exists some convergent subsequence $(a_{n_k})_{k\in\mathbb{N}}$ with $\lim_{k\To\infty}a_{n_k}=a\in M$.
\end{enumerate}
\end{Definition}
